...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Libro</h1>
        <h1 class="pull-right">
            <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{{ route('libros.create') }}">Agregar  libro</a>
        </h1>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'libros.index', 'method'=>'get']) !!}
